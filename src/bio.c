 ...
 */
struct buf* bread(DeviceCode *dev, blkno)
{
    struct buf *rbp;
 ...
 */
int incore(DeviceCode *adev, int blkno)
{
     intptr_t dev;
     struct buf *bp;
     struct devtab *dp;
...
rhstart(struct buf *bp, int *devloc, int devblk, int *abae)
{
     intptr_t *dp;
     struct buf *rbp;
     intptr_t com;
